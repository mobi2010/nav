...
<div class="breadcrumbContainer">
    <ul class="breadcrumb"><li class="active">Add Tag</li></ul>       
</div>
...
<table class="table table-striped table-bordered" style="width: 100%;" id="tag_table">
    ...
    <tr >
        ...
        <td>
        <?=html_select(['name'=>'tag_type_id','selected'=>$dataModel['tag_type_id'],'options'=>$tagtypeModel]);?>
        </td>
    </tr>
    <tr >
...
$(document).ready(function(){
    $('#saveBtn').click(function(){
        ...
        $.post("<?=base_url('admin/tag/save');?>",$('#ci3Form').serialize(),function(dt){
            $.common.alert(dt);
