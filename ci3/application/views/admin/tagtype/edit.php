...
<div class="breadcrumbContainer">
    <ul class="breadcrumb"><li class="active">Add Tag Type</li></ul>       
</div>
<form id="ci3Form" method="post">
<table class="table table-striped table-bordered" style="width: 100%;" id="tagtype_table">
    <tr >
        ...
        <?php 
            ...
            echo html_hidden(['name'=>'type','value'=>$tagtypeType]); 
        ?>
        </td>
    </tr>
    <tr >
...
$(document).ready(function(){
    $('#saveBtn').click(function(){
        ...
        $.post("<?=base_url('admin/tagtype/save');?>",$('#ci3Form').serialize(),function(dt){
            $.common.alert(dt);
