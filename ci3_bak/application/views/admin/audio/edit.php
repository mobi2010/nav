...
<form id="ci3Form" enctype="multipart/form-data" action="<?=ci3_url('admin/audio/save')?>" method="post">
    <table class="table table-striped table-bordered" style="width: 100%;" id="tag_table">
        ...
        <tr >
            <td><label>音频地址:</label></td>
            <td>
            <?=html_text(['name'=>'audio_url','value'=>$dataModel['audio_url']]);?>
            </td>
        </tr>
        <tr>
